...
alter table if exists anime_studios add constraint FKqb9vo4fy4r3y9csl1j3lqc9gy foreign key (anime_id) references anime;create table anime (episodes integer, mal_id integer, year integer, id bigserial not null, rank bigint, rating varchar(255), season varchar(255), status varchar(255), title varchar(255), title_english varchar(255), title_japanese varchar(255), url varchar(255), primary key (id));